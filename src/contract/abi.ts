...
export const FORTICHAINABI: Abi = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        type: "function",
        name: "is_validator_assigned_to_project",
        inputs: [
          {
            name: "project_id",
            type: "core::integer::u256",
      ...
      {
        type: "function",
        name: "get_validator_approval_rate",
        inputs: [
          {
            name: "validator",
            type: "core::starknet::contract_address::ContractAddress",
      ...
      {
        type: "function",
        name: "get_validator_total_bounty_won",
        inputs: [
          {
            name: "validator",
            type: "core::starknet::contract_address::ContractAddress",
      ...
      {
        type: "function",
        name: "get_assigned_projects_for_researcher",
        inputs: [
          {
            name: "researcher",
            type: "core::starknet::contract_address::ContractAddress",
      ...
      {
        type: "function",
        name: "get_researcher_total_projects_worked_on",
        inputs: [
          {
            name: "researcher",
            type: "core::starknet::contract_address::ContractAddress",
      ...
      {
        type: "function",
        name: "get_researcher_vulnerability",
        inputs: [
          {
            name: "researcher",
            type: "core::starknet::contract_address::ContractAddress",
